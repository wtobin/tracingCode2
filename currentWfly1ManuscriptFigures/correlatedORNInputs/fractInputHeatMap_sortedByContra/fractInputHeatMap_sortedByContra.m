...
% mean CONTRALATERAL percentage (averaged across all CONTRALATERAL PNs) 
...
[v2 i2]=sort(mean(contactNum_Fract(length(ORNs_Left)+1:end,[1,2,5])'));
...
%% Plotting matricies sorted by mean ipsi strength
