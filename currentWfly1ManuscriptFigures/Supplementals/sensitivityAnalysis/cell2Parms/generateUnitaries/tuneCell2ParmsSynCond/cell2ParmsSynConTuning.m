...
system('mkdir simulations/cell2ParmsCondAdj')

 %path to the dir containing the hoc files to be run
path1=['~/nC_projects/',PN,'_allORNs/simulations/cell2ParmsCondAdj/'];
cd(path1)
 
% Copy the contents of the cell2Parms dir to this dir
system('cp -a ../cell2Parms/. ./')
...
system(['sed -i -e ''s#\/simulations\/cell2Parms\/#\/simulations\/cell2ParmsCondAdj\/#'' ', PN,'_allORNs.hoc'])
...
system('cp DoubExpSynA.mod ../cell2Parms/')
