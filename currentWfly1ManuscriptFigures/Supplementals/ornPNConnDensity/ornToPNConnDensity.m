...
ax=gca;
ax.XTickLabel={'Left Glomerulus','Right Glomerulus'};
ylabel('Tbar Counts')
ylim([0 80])
title('left ORNs')
...
subplot(1,2,2)
boxplot([[leftPreSites(28:end)]';[rightPreSites(27:end)]'], [ones(25,1); 2*ones(26,1)])
meanTbarDiff=(mean([leftPreSites(28:end)]')/mean([rightPreSites(27:end)]')-1)*100;
text(1,70,[num2str(meanTbarDiff),'% diff between means' ])
ax=gca;
ax.XTickLabel={'Left Glomerulus','Right Glomerulus'};
ylabel('Tbar Counts')
...
subplot(1,2,1)
boxplot([[leftPNCon(1:27)]';[rightPNCon(1:26)]'], [ones(27,1); 2*ones(26,1)])
meanTbarDiff=(mean([leftPNCon(1:27)]')/mean([rightPNCon(1:26)]')-1)*100;
text(1,15,[num2str(meanTbarDiff),'% diff between means' ])
ax=gca;
ax.XTickLabel={'Left Glomerulus','Right Glomerulus'};
ylabel('PN Connections')
ylim([0 110])
...
subplot(1,2,2)
boxplot([[leftPNCon(28:end)]';[rightPNCon(27:end)]'], [ones(25,1); 2*ones(26,1)])
meanTbarDiff=(mean([leftPNCon(28:end)]')/mean([rightPNCon(27:end)]')-1)*100;
text(1,15,[num2str(meanTbarDiff),'% diff between means' ])
ax=gca;
ax.XTickLabel={'Left Glomerulus','Right Glomerulus'};
ylabel('PN Connections')
