...
for p=1:5
    ...
    if p<=3
        ...
        errorbar([1 2],[mean(leftPNIpsiAmps(p,:)) mean(leftPNContraAmps(p,:))],...
            [std(leftPNIpsiAmps(p,:))/sqrt(numel(leftPNIpsiAmps(p,:)))...
            std(leftPNContraAmps(p,:))/sqrt(numel(leftPNContraAmps(p,:)))],...
        ...
        errorbar([1 2],[mean(rightPNIpsiAmps(rightCounter,:)) mean(rightPNContraAmps(rightCounter,:))],...
            [std(rightPNIpsiAmps(rightCounter,:))/sqrt(numel(rightPNIpsiAmps(rightCounter,:)))...
            std(rightPNContraAmps(rightCounter,:))/sqrt(numel(rightPNContraAmps(rightCounter,:)))],...
            'Color','k', 'Marker', 'o', 'MarkerFaceColor','k')
