...
for c=0:9
    ...
    elseif c==4
        ...
        testVals=[meanDiffL(1,2501:5000)';meanDiffL(5,2501:end)'];
        testCat=[ones(size(meanDiffL(1,2501:5000)'));2*ones(size(meanDiffL(5,2501:end)'))];
    ...
    elseif c==5
        ...
        testVals=[meanDiffL(1,2501:end)';meanDiffL(6,2501:end)'];
        testCat=[ones(size(meanDiffL(1,2501:end)'));2*ones(size(meanDiffL(6,2501:end)'))];
    ...
    elseif c==6
        ...
        testVals=[meanDiffL(1,2501:end)';meanDiffL(7,2501:end)'];
        testCat=[ones(size(meanDiffL(1,2501:end)'));2*ones(size(meanDiffL(7,2501:end)'))];
    ...
    elseif c==7
        ...
        testVals=[meanDiffL(1,2501:end)';meanDiffL(8,2501:end)'];
        testCat=[ones(size(meanDiffL(1,2501:end)'));2*ones(size(meanDiffL(8,2501:end)'))];
    ...
    elseif c==8
        ...
        testVals=[meanDiffL(1,2501:end)';meanDiffL(9,2501:end)'];
        testCat=[ones(size(meanDiffL(1,2501:end)'));2*ones(size(meanDiffL(9,2501:end)'))];
    ...
    elseif c==10
        ...
        testVals=[meanDiffL(1,2501:end)';meanDiffL(10,2501:end)'];
        testCat=[ones(size(meanDiffL(1,2501:end)'));2*ones(size(meanDiffL(10,2501:end)'))];
