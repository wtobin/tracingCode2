...
edges=[0.5:1:7.5];
subplot(2,2,1)
histogram(numPostPNL, 'BinEdges',edges)
%ylabel('Counts')
%xlabel('Number of Postsynaptic PN Profiles')
title('Left DM6')
xlim([0 7.5])
ylim([0 1200])
set(gca,'FontSize',18)
...
subplot(2,2,3)
histogram(numPostPNR, 'BinEdges',edges)
ylabel('Counts')
xlabel('Number of Postsynaptic PN Profiles')
title('Right DM6')
xlim([0 7.5])
...
edges=[0.5:1:9.5];
subplot(2,2,2)
histogram(numPostNonPNL, 'BinEdges',edges)
%ylabel('Counts')
%xlabel('Number of Postsynaptic PN Profiles')
title('Left DM6')
xlim([0 9.5])
...
subplot(2,2,4)
histogram(numPostNonPNR, 'BinEdges',edges)
ylabel('Counts')
xlabel('Number of Postsynaptic Non-PN Profiles')
title('Right DM6')
xlim([0 9.5])
ylim([0 800])
set(gca,'FontSize',18)
