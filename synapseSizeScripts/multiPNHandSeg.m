...
load('/Users/williamtobin/Desktop/wfly1_synapseVols2/multiSynList.mat')
handles.connIDs=multiSynList;


%Create an array with one more column than hand seg to keep track of which
%files have already been completed
handles.completed=zeros(126,1);
