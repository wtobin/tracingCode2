...
%synapse, column 1 is tbar volume in nm^3, column 2 is pn area 
%in nm^2, column 3 is the number of postsynaptic profiles at the synapse 
%and column 4 is number of postsynaptic pn profiles. 
...
%Tracer 3 comparison
%avePNRatios_relT1(1,3)=aveRatios(2,2)*aveRatios(4,2); %error
%avePNRatios_relT1(3,3)=aveRatios(2,2)*(1/aveRatios(4,2)); %error
avePNRatios_relT1(1,3)=aveRatios(2,2)*(1/aveRatios(4,2));
avePNRatios_relT1(3,3)=aveRatios(2,2)*aveRatios(6,2);
