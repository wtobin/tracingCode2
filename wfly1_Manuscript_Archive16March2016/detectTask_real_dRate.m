...
function [] = detectTask_real_dRate( jobNum, reps, dF, PN,resDirName)
...
for i= jobNum*reps-reps+1:jobNum*reps
    ...
    htemGroupBase=['/groups/htem/analysis/wfly1/nC_projects/',PN,'_allORNs/simulations/detTask_real_dRate'];
