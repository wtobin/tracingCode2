...
figure()
set(gcf, 'Color','w')
plot([0:1/40:125],pn1UEPSPs(uMaxI,1:5001), 'b')
hold on
plot([0:1/40:125],pn1UEPSPs(uMinI,1:5001), 'b')

plot([0:1/40:125],pn1MEPSPs(mMaxI,1:5001), 'r')
plot([0:1/40:125],pn1MEPSPs(mMinI,1:5001), 'r')
