...
scatter(mean(uEPSP_Amps(1:26,1:3))./max(uEPSP_Amps(:,1:3)),mean(uEPSP_Amps(26:end,1:3))./max(uEPSP_Amps(:,1:3))) %, 'filled')

hold on

scatter(mean(uEPSP_Amps(27:end,4:5))./max(uEPSP_Amps(:,4:5)),mean(uEPSP_Amps(1:25,4:5))./max(uEPSP_Amps(:,4:5)),'r')%, 'filled','r')
...
scatter(mean(uEPSP_Amps(1:26,1:3)),mean(uEPSP_Amps(26:end,1:3)), 'filled')

hold on

scatter(mean(uEPSP_Amps(27:end,4:5)),mean(uEPSP_Amps(1:25,4:5)), 'filled','r')
...
for p=1:5
    ...
    if p<=3
        scatter(p*ones(1,26), uEPSP_Amps(1:26,p),'b')
        hold on
        scatter(p*ones(1,25),uEPSP_Amps(27:end,p),'r')
    else
        scatter(p*ones(1,25), uEPSP_Amps(27:end,p),'b')
        hold on
        scatter(p*ones(1,26),uEPSP_Amps(1:26,p),'r')
    end
