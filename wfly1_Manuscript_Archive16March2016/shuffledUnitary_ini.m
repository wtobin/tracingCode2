%{
shuffUnitaries initialization commands. These should be run for each PN once
before running the shuffUnitaries simulations. PLEASE READ OVER/THINK CAREFULLY,
...
%% For each PN copy generatedNEURON and modify the hoc code 
...
system('mkdir simulations/shuffUnitaries')
...
% Copy the contents of the generatedNEURON dir to shuffUnitaries
