...
function [] = detectTask_eq_dRate( jobNum, reps, dF, PN, resDirName)
...
path1=['/home/wft2/nC_projects/',PN,'_allORNs/simulations/detTask_eq_dRate/'];
cd(path1)
...
for i= jobNum*reps-reps+1:jobNum*reps
    ...
    htemGroupBase=['/groups/htem/analysis/wfly1/nC_projects/',PN,'_allORNs/simulations/detTask_eq_dRate'];
    resultDir=[htemGroupBase,'/results_dRate_',resDirName,'/eq_dF',num2str(dF),'_rep',num2str(i)];
    mkdir(resultDir)
