...
histogram(ornOuts{t},Edges,'FaceColor','k')
...
histogram(pnOuts{t},Edges,'FaceColor','k')
title(types(t),'FontSize', 16)
ylim([0 200])
xlim([0 12])
ax=gca;
...
types={'MG-->PN','MG-->MG','MG-->ORN'};

for t=1:3

subplot(3,3,t+6)
[N Edges]=histcounts(lnOuts{t})
histogram(lnOuts{t},Edges,'FaceColor','k');
title(types(t),'FontSize', 16)
ylim([0 400])
xlim([0 12])
