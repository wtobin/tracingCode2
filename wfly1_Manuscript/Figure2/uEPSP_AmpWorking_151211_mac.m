...
pn3LS_Vm=importdata(strcat(baseDir, 'PN3LS_151211/simulations/unitaries_151211/neuron_PN3_LS_sk_668267_0.dat'));
pn3LS_simTime=importdata(strcat(baseDir, 'PN3LS_151211/simulations/unitaries_151211/time.dat'));

%collect ORN skel IDs from PN3LS hoc file and save them in a txt file
idCommand=['grep -Po ''(?<=objref spikesource_)\d*'' ', ...
    baseDir,'PN3LS_151211/generatedNEURON/PN3LS_151211.hoc > ',baseDir,'PN3LS_151211/simulations/unitaries_151211/ornIDs.txt'];
    
system(idCommand);
ornSkelIDs=importdata([baseDir,'PN3LS_151211/simulations/unitaries_151211/ornIDs.txt']);

fireTimeCmd=['grep -Po ''((?<=.start = )\d*)'' ', baseDir,...
    'PN3LS_151211/generatedNEURON/PN3LS_151211.hoc > ',baseDir, 'PN3LS_151211/simulations/unitaries_151211/ornSpikeTimes.txt'];
system(fireTimeCmd);
fireTimes=importdata([baseDir,'PN3LS_151211/simulations/unitaries_151211/ornSpikeTimes.txt']);
