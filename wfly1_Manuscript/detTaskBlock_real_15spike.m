...
function [] = detTaskBlock_real_15spike( jobNum, reps, dF, PN)
...
resultDir=[htemGroupBase,'/results_15Spikes/real_dF',num2str(dF),'_rep',num2str(i)];
mkdir(resultDir)
...
%require 15 spikes to be fired
while sum(spikeTrain(:))~=15
