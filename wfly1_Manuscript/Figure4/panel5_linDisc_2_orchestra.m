...
%% Save spikeVector Files and Dirs for all parallel reps I want to run

%working with PN1 for right now
...
% Change the path to spike vector files to reflect their location on
% orchestra
vecFileRefCmd=['sed -i -e ''s/\/home\/simulation\//\/home\/wft2\//'' ',PN, '_151125.hoc '];
system(vecFileRefCmd)
...
if strcmp(PN, 'PN1RS') == 1 || strcmp(PN,'PN2RS') == 1 %For Right PNs
    ...
    activeSyns=pullContactNums(ORNs_Right,path1);
...
%Define the number of parallel repetitions I want to run
parReps=100;

% create a vector of randomly drawn ones or twos indicating whther
% these instances will be spontaneous or driven
ctgs=randi(2,[parReps,1]);
