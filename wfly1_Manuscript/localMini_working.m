...
for p=1:length(PN_Names)
    ...
    cd('/home/simulation/nC_projects/');
...
for p=1:length(PN_Names)
    ...
    cd(['/home/simulation/nC_projects/',PN,'_localMini/generatedNEURON']);
    ...
    simPatCmd=['sed -i -e ''s/\/home\/william\//\/home\/simulation\//'' ',PN, '_151125.hoc'];
    system(simPatCmd)
    ...
    simDir=['/home/simulation/nC_projects/',PN,'_localMini/simulations/'];
    ...
    mkdir(['/home/simulation/nC_projects/',PN,'_localMini/simulations/localMini']);
    cpCmd=['cp -a /home/simulation/nC_projects/',PN,'_localMini/generatedNEURON/. /home/simulation/nC_projects/',PN,'_localMini/simulations/localMini/'];
    system(cpCmd);
...
for p=1:length(PN_Names)
    ...
    % Move to the current PNs localMini/generatedNEURON dir
    cd(['/home/simulation/nC_projects/',PN,'_localMini/simulations/localMini/']);
    ...
    vecFileCmd=['grep -oP ''\[\d*\].ropen\("/home/simulation/nC_projects/',PN,'_localMini/spikeVectors/spikeVector\K\d*'' ' , PN,'_151125.hoc'];
    ...
    for s=1:numel(vecFileNums)
        ...
        saveSpikeVectors(vecFileNums,[vecFileNums(s) 1],{10},['/home/simulation/nC_projects/',PN,'_localMini/spikeVectors']);
