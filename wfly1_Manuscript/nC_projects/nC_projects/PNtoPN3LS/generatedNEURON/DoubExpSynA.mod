COMMENT
   ...
   **************************************************
   ...
   DoubExpSynA (Type: Synaptic mechanism, Model: Template based ChannelML file)

   with parameters: 
   /channelml/@units = Physiological Units 
   /channelml/notes = ChannelML file describing a single synaptic mechanism 
   /channelml/synapse_type/@name = DoubExpSynA 
   ...
   /channelml/synapse_type/doub_exp_syn/@max_conductance = 1.0E-7 
   /channelml/synapse_type/doub_exp_syn/@rise_time = .2 
   /channelml/synapse_type/doub_exp_syn/@decay_time = 1.1 
   /channelml/synapse_type/doub_exp_syn/@reversal_potential = -10 

// File from which this was generated: /home/william/nC_projects/PNtoPN3LS/cellMechanisms/DoubExpSynA/DoubExpSyn.xml

// XSL file with mapping to simulator: /home/william/nC_projects/PNtoPN3LS/cellMechanisms/DoubExpSynA/ChannelML_v1.8.1_NEURONmod.xsl
