COMMENT
   ...
   **************************************************
   ...
   /channelml/channel_type/current_voltage_relation/@default_gmax = 0.048 

// File from which this was generated: /home/william/nC_projects/PNtoPN3LS/cellMechanisms/LeakConductance/LeakConductance.xml

// XSL file with mapping to simulator: /home/william/nC_projects/PNtoPN3LS/cellMechanisms/LeakConductance/ChannelML_v1.8.1_NEURONmod.xsl
...
PARAMETER { 
    ...
    gmax = 0.000048 (S/cm2)  ? default value, should be overwritten when conductance placed on cell
